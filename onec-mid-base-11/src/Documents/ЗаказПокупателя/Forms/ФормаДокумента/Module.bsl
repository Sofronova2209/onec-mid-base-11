...
Процедура ПересчитатьТаблицу(Команда)
	...
	// Команда используется для пересчета скидки и суммы в табличных частях "Товары" и "Услуги" документа.
    // Скидка устанавливается равной значению "СогласованнаяСкидка" из шапки документа.
    // Затем для каждой строки вызывается процедура "РассчитатьСуммуСтроки" для пересчета суммы с учетом новой скидки.
